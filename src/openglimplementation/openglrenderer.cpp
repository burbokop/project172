...
void OpenGLRenderer::applyLensEffect(const e172::Vector &point0, const e172::Vector &point1, double coefficient) {

}

void OpenGLRenderer::setFullscreen(bool value) {
...
e172::Vector OpenGLRenderer::screenSize() const {
