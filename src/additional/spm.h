...
class SPM {
private:
    static VisualEffect *appliedEffect;
    static bool effectLocked;

    static SDL_Surface *effect(SDL_Surface *surface);
public:
    ...
    static void BlitRotatedSurface(SDL_Surface *surface, SDL_Surface *screen_surface, int x, int y, double angle, double zoom, int smooth);
    ...
    static void BlendedText(SDL_Surface *surface, std::string text_line, TTF_Font *text_font, int text_x, int text_y, Uint32 color, Uint32 wrap = 1024);
