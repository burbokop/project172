...
namespace SPM {
    ...
    inline SDL_Surface *CreateARGB32Surface(int width, int height);
    inline SDL_Surface *CreateRGBA32Surface(int x, int y);
    inline SDL_Surface *CreateABGR32Surface(int x, int y);
    ...
    void DiagonalGrid(SDL_Surface *surface, int point1_x, int point1_y, int point2_x, int point2_y, int interval, Uint32 color);
